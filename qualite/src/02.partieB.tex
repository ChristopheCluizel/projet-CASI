...
\label{sec:B3}
  ...
  Il existe certains problèmes avec les connections de longue vie avec HTTP, c'est pourquoi l'API de Twitter envoie des \textit{keep-alive} toutes les 30 secondes sous la forme de retour à la ligne.\\
